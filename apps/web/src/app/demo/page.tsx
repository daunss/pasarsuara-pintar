      ...
      <div className="bg-gradient-to-r from-green-600 to-blue-600 text-white py-8 sm:py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center">
            <h1 className="text-2xl sm:text-4xl lg:text-5xl font-bold mb-4 flex items-center justify-center gap-2 sm:gap-3">
              <Sparkles className="w-8 h-8 sm:w-12 sm:h-12" />
              Suara Niaga Pintar Demo
              <Sparkles className="w-8 h-8 sm:w-12 sm:h-12" />
            </h1>
            <p className="text-base sm:text-xl text-green-100 mb-6">
            ...
            <div className="flex flex-wrap justify-center gap-4 sm:gap-8 text-center">
              <div>
                ...
                <div className="text-green-100 text-sm sm:text-base">Voice Processing</div>
              </div>
              <div>
                <div className="text-xl sm:text-3xl font-bold">🤖 95%</div>
                <div className="text-green-100 text-sm sm:text-base">Intent Accuracy</div>
              </div>
              <div>
                <div className="text-xl sm:text-3xl font-bold">💰 30%</div>
                <div className="text-green-100 text-sm sm:text-base">Cost Reduction</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex justify-center gap-4 mb-8 flex-wrap">
          <button
            ...
            className={`px-4 sm:px-8 py-3 sm:py-4 rounded-lg font-bold text-sm sm:text-lg transition-all flex items-center gap-2 sm:gap-3 ${
              activeTab === 'voice'
